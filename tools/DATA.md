...
--- ${blurb-asn-country} ---
Created by merging 5 RIRs ASN databases: [afrinic](https://afrinic.net), [apnic](https://www.apnic.net), [arin](https://www.arin.net), [lacnic](https://www.lacnic.net), [ripe ncc](https://www.ripe.net).
--- ${blurb-dbip-asn} ---
...
Created by merging 5 RIRs ([afrinic](https://afrinic.net), [apnic](https://www.apnic.net), [arin](https://www.arin.net), [lacnic](https://www.lacnic.net), [ripe ncc](https://www.ripe.net)) provided [WHOIS](https://en.wikipedia.org/wiki/WHOIS) database.
Data source licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) by the [NRO](https://www.nro.net/).
...
--- ${license-routeviews} ---
RouteViews databases are licensed under a [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license.
--- ${license-cc0} ---
## License
...
These files are subject to the [Public Domain Dedication and license v1.0](https://opendatacommons.org/licenses/pddl/1.0/). You may use these databases without attribution for any purpose.
--- ${license-geolite2} ---
...
--- ${license-iplocate} ---
IPLocate databases are licensed under a [CC BY SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) license.
